...
#pragma region 범용 포인터
	...
	// 범용 포인터가 가리키는 변수의 자료형으로 형 변환해야 합니다.

#pragma endregion

#pragma region 동적 할당
	// 프로그램을 실행하는 중에
	// 필요한 만큼 메모리를 할당하는 작업입니다.

	//int* ptr = (int * )malloc(sizeof(int)); // 스택 = 힙;
