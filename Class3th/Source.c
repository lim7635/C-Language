...
#pragma region 증감 연산자
	...
	// 후위 증감 연산자는 연산을 수행한 다음 다음 변수의 값을 증감시킵니다.
...
#pragma region for문 응용 문제
	...
	// 1 ~ 5 사이의 값을 순서대로 출력하기(오름차순)
	/*for (int i = 1; i <= 5; i++)
	{
		printf("%d\n", i);
	}*/
	
	// 1 ~ 5 사이의 값을 순서대로 출력하기(내림차순)
	/*for (int i = 5; i >= 1; i--)
	{
		printf("%d ", i);
	}*/
...
#pragma region while문
	...
	// 아래에 있는 명령문의 실행이 다 끝나면 다시 위에 있는
...
#pragma region continue문
	// 해당 조건문만 실행되지 않고, 반복문은 이어서 실행하는 제어문입니다.
